<%@ Page Language="C#" Title="註冊外部登入" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="CRViewerProject.Account.RegisterExternalLogin" %>
